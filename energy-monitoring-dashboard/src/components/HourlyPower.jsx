...
export const HourlyPower =({powerUsageTodayHourly,devicesWithName,devicesInModel})=>{
    // console.log(powerUsageTodayHourly)
    // console.log(devicesInModel)
    let temp = devicesInModel
    powerUsageTodayHourly.map((data)=>{
      // console.log("hi",data)
      for(let i of temp){
        if(i.device_id==data.name){
            data.name =i.components[0].component_name;
        }
      }
    })
    const options = {
